...
CREATE INDEX IF NOT EXISTS idx_staff_profiles_user_id ON staff_profiles(user_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_staff_profiles_role ON staff_profiles USING GIN(roles) WHERE deleted_at IS NULL;
